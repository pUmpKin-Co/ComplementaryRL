...
def main():
    ...
    init()
    from roll.pipeline.agentic.knowledge_model_pipeline import RefactoredMemoryActorPipeline as KnowledgeModelPipeline

    pipeline = KnowledgeModelPipeline(pipeline_config=ppo_config)
