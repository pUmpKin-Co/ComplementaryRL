...
from roll.pipeline.agentic.env_manager.tool_integration_mixin import ToolIntegrationMixin
...
class BaseEnvManager(ToolIntegrationMixin):
    ...
    def build_memory_query(self, last_history: Dict, task_goal: Optional[str] = None) -> str:
        observation = last_history["observation"]
    ...
    def build_memory_value(self, action: str):
        return action
