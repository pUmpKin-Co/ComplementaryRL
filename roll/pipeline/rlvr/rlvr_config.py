...
class RLVRConfig(BaseConfig):
    ...
    record_time_profiler: bool = field(default=False, metadata={"help": "Record time profiler"})
    ...
    def __post_init__(self):
        ...
        if self.async_pipeline:
            ...
            if "sglang" not in self.actor_infer.strategy_args.strategy_name:
                raise ValueError(
                    f"AsyncRLVRPipeline only support sglang strategy but got {self.actor_infer.strategy_args.strategy_name}"
                )
